...
% NO VIDEO HERE.  JUST CONFIRMS THE ACCURATE RECONSTRUCTION
...
% A SERIES OF IMAGES, SAMPLED, ON THE WAY TO THE LINE RECONSTRUCTION
% SPECIAL CASE.  NO COMPLEX EXPONENTIALS
...
% Use MPEG-4 for good compression and wide compatibility
writerObj = VideoWriter(outputVideoFile, 'Motion JPEG AVI'); 

writerObj.FrameRate = 10; % Set desired frames per second (e.g., 10 or 15)
...
% Close the video writer object after completing the harmonic summation
close(writerObj);
