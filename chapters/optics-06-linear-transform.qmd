...
![Pictures of 2d FFT Amplitude spectrum. [See fise_harmonicsLine](../code/02Optics/html/fise_harmonicsLine.html){target=_blank}](images/optics/otf2d.png){#fig-optics-otf2d width=70%}
...
![The log10 amplitudes of the two-dimensional Fourier Transform coefficients are shown in the bottom row; the corresponding images are shown in the top row.[fise_otf2dParts](../code/02Optics/fise_otf2d)](images/optics/otf2dParts.png){#fig-optics-otf2dparts width=70%}
