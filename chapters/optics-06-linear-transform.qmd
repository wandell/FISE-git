...
![Pictures of 2d FFT Amplitude spectrum](images/optics/otf2d.png){#fig-optics-otf2d width=70%}

Get to image representations of the harmonic images.

Parts of the Fourier representation (center, edges, and so forth)

![My favorite singer. 2d FFT Amplitude spectrum and then carved out](images/optics/otf2dParts.png){#fig-optics-otf2dparts width=70%}
