...
To this point, we have considered the environmental light field [@sec-chapter-lightfields], how it is measured by the optics [@sec-optics], and how it is then converted into electrons at each pixel [@sec-sensors]. We have also considered how the visual system would capture the same light field.  
