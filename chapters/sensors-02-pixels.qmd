# Pixel Structures and Properties {#sec-pixels}
...
## Semiconductor Physics and Electron Behavior {#sec-semiconductor-physics}
...
### The Bandgap and Photon Absorption {#sec-bandgap-photon-absorption}
...
## CMOS Pixel Circuit Architectures {#sec-cmos-pixel-architectures}
...
## Pixel Circuit Performance and Characterization {#sec-pixel-circuit-performance}
...
### Well Capacity and Pixel Dynamic Range {#sec-wellcapacity-dynamicrange}
...
### Pixel Response Curve and Linearity {#sec-pixel-responsecurve-linearity}
...
The units of conversion gain are volts per electron.  Thus, if we store 100 electrons in the diffusion node, the readout voltage will be $100 \times CG$.  The 

Explain that many sensors enable the user to adjust the gain of the source buffer.  Define conversion gain here.  Explain why one would do this.  Talk about the hardware.

## Sources of Pixel Noise {#sec-sources-pixel-noise}
...
### Dark Current and Its Effects {#sec-dark-current-effects}
...
### Temperature Effects on Sensor Performance {#sec-temperature-effects}
...
## Array-Level Noise and Nonuniformity {#sec-array-noise-nonuniformity}
