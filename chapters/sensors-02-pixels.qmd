...
The role of the other essential pixel components, the color filter arrays and microlenses, is explained in Section @sec-sensor-components.  In @sensor-system-modeling-overview I describes how to calibrate and model sensor performance, from the scene light field to image capture.
...
![Multiplex readout explanation](images/sensors/14-pixels/03-CMOS-multiplex-readout.png){#fig-cmos-multiplex width=60%}
...
::: {.callout-note collapse="true" title="Commercialization of the digital pixel sensor"}
