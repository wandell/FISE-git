...
The role of the other essential pixel components, the color filter arrays and microlenses, is explained in Section @sec-sensor-components.  In @sec-system-modeling-overview I describe how to calibrate and model sensor performance, from the scene light field to image capture.
