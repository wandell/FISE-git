...
*   **[Optics Glossary: Basic Distances and Planes](resources/optics-glossary.qmd):** A reference table and guide clarifying fundamental terminology—distinguishing intrinsic lens **focal length** ($f$), conjugate **image distance** ($d_i$), physical **sensor distance** ($d_s$), and why to avoid ambiguous terms like "focal distance."
*   **[The Ideal Thin Lens](resources/optics-ideal-lens.qmd):** Conditions and surface profiles (aspheric hyperboloids and Coddington best-form spherical singlets) for achieving diffraction-limited focus.
*   **[Multi-Element Lens Calculations: The ABCD Matrix](resources/optics-abcd.qmd):** Ray transfer matrix analysis for multi-element and thick lens systems.
*   **[The Poisson Spot and Wave Theory](resources/optics-poisson.qmd):** Historical context and experimental demonstrations of Huygens' wave theory.
*   **[Diffraction and Wave Propagation Notes](resources/optics-diffraction.qmd):** Further mathematical derivations and notes on wave optics and diffraction.