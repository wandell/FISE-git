...
Common mirrors are very close to perfect specular reflectors, and for scientific applications it is possible to make them increasingly perfect. There are many materials that are rather specular, but not perfectly so.  In these materials an incident ray is reflected mainly in the specular direction, but there is some randomness 
