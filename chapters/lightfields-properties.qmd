...
Over the years a number of groups have measured the reflectance of many types of materials, including paints, minerals, plants, clothing, and various biological specimen such as skin and teeth. As a general rule, the spectral reflectances are approximated to an accuracy of a fraction of a percent by linear models using between 3 and 8 basis functions. There are also many similarities between the best linear models for the different types of common samples. One important early set of measurements came from Mike Vrhel and colleagues [@1994-MeasurementAnalysisObject], who sampled surface spectral reflectance functions of a few hundred objects of different types (paint chips, natural and man-made objects, food).
