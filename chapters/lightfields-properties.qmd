...
Over the years a number of groups have measured the reflectance of many types of materials. There are studies reporting measurements of paints, surfaces, minerals, plants, clothing, biological speciments. In all cases, the spectral reflectances can be approximated to an accuracy of a fraction of a percent by linear models using between 3 and 8 basis functions.
