...
The Sun is the Earth's main source of radiation. In the visible range, radiation emitted from the Sun's surface is relatively stable over time. But as the radiation passes through the Earth's atmosphere, it is substantially altered by particles and moisture. Further, depending on the time of day the radiation may have to travel longer distance through the atmosphere. This path length difference also changes the spectral composition of the radiation arriving at the Earth's surface.
...
![The mean solar radiation is quite stable over time. The perfectly smooth curve that we might expect is interrupted by many lines. These are caused by absorptions by atoms and ions in the Sun's chromosphere.](/images/lightfields/01-Solar.png){fig-align="center"}

Additionally, several spectral absorption lines in the spectrum measured at the Earth's surface are caused by water vapor (H₂O) and other molecules on the atmosphere, rather than from the Sun itself. The variation from atmospheric properties can change relatively quickly and with the weather.
