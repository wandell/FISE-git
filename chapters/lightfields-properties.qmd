...
Maybe put in some example measurements at the Earth's surface from skylight. From Jeff's data?  Online examples?
...
![Average daylight measurements on the Stanford campus (solid) and CIE daylight basis fit to the measured average (dotted). The solid circles are placed at the locations of Fraunhofer and water vapor wavelengths.](images/lightfields/01-stanfordsun.png){#fig-stanfordsun fig-align="center" width="60%"}
:::
