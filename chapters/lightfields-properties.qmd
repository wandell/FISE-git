...
A related challenge in human vision is quantifying the appearance of things and stuff. Surface reflectance, texture, and context (e.g., ambient illumination, or what is nearby) all play a role in determining appearance to a human @Schmid2023-materialperception. Whether there is value in the corresponding notion - appearance for a computer vision system - is little studied. One notion of the meaning of appearance for a computer vision system is how well it estimates the reflectance and texture of the material.
:::

Over the years a number of groups have 
