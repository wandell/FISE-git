...
A full description of the interaction can be complex and difficult to measure. Consider that the radiation incident on a small patch of a material can arise from many different directions. As we measure for each of the incident angles (two dimensions), the radiation may be reflected in many different directions (two more dimensions). The properties of the reflected light may depend on the wavelength and polarization of the incident light (two more dimensions). Finally, for most surfaces the wavelength of the incident and reflected light is the same; but there are some materials (fluorescent) that convert radiation at an input wavelength into exitant light at different wavelengths.  Fluorescent materials are particularly important in biomedical applications, and also to people who manufacture clothing detergent.

There are aspects of surface reflectance that are simple and useful to know.  For many materials, no matter what direction the incident light may arrive from, the reflected light will be reflected relatively uniformly in all directions.  That is why even when we illuminate a surface with a narrow laser beam from one direction, we can see the reflected light even as we move around to see the surface from different angles.  This type of reflectance is called diffuse reflectance, and it is also named 'Lambertian reflectance', for the Swiss physicist, Johan Lambert (1728-1888) who formalized the mathematical description.  
<!--
...
Maloney dissertation and Krinov, the Russian guy. What was his name and story?
