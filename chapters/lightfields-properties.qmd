...
$$ d_j(\lambda) = \sum_{i=1}^{N} B_i(\lambda) w_{ij}$$
...
![Illustration of the two BRDF angle parameters. These are used to define both the angle of the incident light ray and the angle of the reflected light rays. If we fix the wavelength and angle of the incident light ray, we can specify the relative intensity of the reflected ray as an image that spans the two angle parameters.](images/lightfields/01-azimuthelevation-0.png){#fig-azimuth-elevation fig-align="center" width="50%"}
...
```{=html}
<!-- 
 ![The azimuth and elevation of a ray.](images/lightfields/01-azimuthelevation-1.png){#fig-azimuth-elevation fig-align="center" width="60%"}
...
[Source for azimuth and elevation and zenity.](https://www.researchgate.net/publication/334197029_A_new_model_for_reduction_of_Azimuth_asymmetry_biases_of_tropospheric_delay/figures?lo=1)
