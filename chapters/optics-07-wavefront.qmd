...
Modeling light fields as the sum of waves is less intuitive than imaging rays. One purpose of this chapter is to provide some intuitive explanations of wave properties. In particular, I would like to connect the concepts of complex number representations of the wavefront with the pupil function and the point spread function. The wavefront itself is not something an ordinary image sensor can measure directly; the instruments that measure it, and their applications in astronomy and vision science, are described in the next chapter (@sec-optics-wavefront-sensing).
