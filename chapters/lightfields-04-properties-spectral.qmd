...
::: {.callout-note title="Natural retroreflection" collapse="true"}
There are natural objects that exhibit retroreflection! 

* Animal Eyeshine: The most well-known natural example is the "eyeshine" seen in the eyes of many nocturnal animals, such as cats, deer, and owls, when light shines on them in the dark. This occurs due to a layer behind the retina called the tapetum lucidum. This layer acts as a retroreflector, reflecting light that has passed through the retina back to the photoreceptor cells, giving the animal a second chance to detect it. This improves their night vision and causes their eyes to appear to glow when illuminated. The mechanism is similar to a "cat's eye" retroreflector design, using a lens (the eye's lens) and a reflective surface (the tapetum lucidum). When I teach about the visual pigments in the retina, I often show this picture taken by William Rushton in his Florida lab of the eye shine from an alligator eye!

![Alligator eyeshine](images/lightfields/04-spectral/alligator-eyeshine.png){#fig-alligator-eyeshine }
