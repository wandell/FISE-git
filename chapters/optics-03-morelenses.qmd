...
The methods used to characterize thin lenses (@sec-optics-geometric) can be extended to more complex optics. This is not an optics text -and I am not an expert in optics- so I won't follow that path deeply here. But, I do want you to know at least a little about those topics. In this section, I will start down the path of using the ideas from thin lenses to characterize more complex optical systems. 
