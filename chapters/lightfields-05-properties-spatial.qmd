...
One idea is that natural images must satisfy this simple statistical measure: if we express the image as the weighted sum of harmonic functions (sines and cosines), the amplitudes of the harmonics decline with spatial frequency.  This was the idea suggested in an early paper by Ruderman and Bialek [@Ruderman1994-imagestats] who set out to measure natural image spatial statistics. The analysis was confirmed and extended by others, including @Simoncelli2001-imagestats @Geisler2008-imagestats @mumford-deadleaves.
