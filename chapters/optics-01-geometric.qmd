...
There are cases in nature -and industry- of non-circular apertures.  These lead to point spread functions that must be described as two-dimensional images.  In general, biological optics - inluding most people -are often imperfect and deviate from circular symmety.  In this section I explain how to calculate the diffraction limited point spread for different shapes, and I describe some of the biological pupils from different species.

### Non-circular pinholes 

Create an ISETCam script with a rectangular apodization.  
