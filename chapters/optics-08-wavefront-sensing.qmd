 ...
 **Spatial light modulators (SLMs)** dynamically control the properties of a light field, on a pixel-by-pixel basis. They are arrays of small, programmable optical elements. The way we describe them is is based on the representation of light in terms of wavefronts (@sec-optics-wavefront).  We can build devices the modulate the phase or the amplitude of the local electrical field.
...
Let's finish with an ISETCam flare example, emphasizing the impact of the aperture.
Aperture shape - non circular causes some stuff.

Pupil functions for in automotive application exampl.e
