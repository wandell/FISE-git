...
This [ISETCam script](https://htmlpreview.github.io/?https://github.com/ISET/isetfise/blob/main/fise/02Optics/fise_opticsCountingPhotons.html){target=_blank} illustrates the calculation. Nearly every sensor simulation we run in ISETCam includes calculations like this.
:::
...
The dual conversion gain method is a true sensitivity adjustment: the method genuinely changes the signal-to-noise by modifying the well capacity. We will review the formulae relating different circuit parameters and signal-to-noise in @sec-system-modeling-overview.
