...
This script plots the focal distance as a function of object distance for lenses with different focal lengths. Notice that the focal plane approaches a constant and stays near that level as relatively large distances. 
