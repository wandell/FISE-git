...
$$ \frac{1}{f}    = \frac{1}{d_i} + \frac{1}{d_o} $$   {#eq-lensequation}

Notice that when $d_o = \infty$, then $d_i = f$.  More generally, if we know the focal length, $f$, and the distance to an object, $d_o$, we can calculate the distance to the focal plane, $d_i$ as
