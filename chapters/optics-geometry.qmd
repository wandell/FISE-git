...
rearranging terms, $$ \frac{d_i}{f}  = 1 + \frac{d_i}{d_o} $$
...
$$\frac{-1}{d_i} = \frac{1}{d_o} - \frac{1}{f}$$ $$ d_i =  \frac{1}{\frac{1}{f} - \frac{1}{d_o}}$$ $$ d_i = \frac{f~d_o}{d_o - f} $$ {#eq-focaldistance}
...
Consider the simple thin lens in @fig-optics-magnification1 with a focal distance of $f = 0.1m$. We draw the rays to the image plane for an object at a distance of $d_o = 0.3m$.
