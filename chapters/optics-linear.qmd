...
An image system may not be shift invariant, perhaps because of geometric distortions. But there may be portions of the visual field and small shifts, for which shift invariance is a good approximation.  These are called *isoplanatic* regions.  One can finds isoplanatic regions near the main optical axis of a system.

Suppose we express image translation as a function, so we translate an image by some amount, $\delta$, and represent this as $T(x,\delta)$, then 
