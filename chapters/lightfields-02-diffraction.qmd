# Pinholes, diffraction and PSFs {#sec-lightfields-diffraction}
...
We will explore the role of the PSF in lens simulation, characterization, and computational imaging methods in @sec-optics-linear and @sec-optics-harmonics.
