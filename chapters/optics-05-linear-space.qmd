...
There is noticeable chromatic aberration for many types of lenses and materials.  The most surprising optical system with a large amount of chromatic aberration is the human eye!  The line spread function (and point spread) of the irradiance at the human retina differs greatly between wavelengths.
...
A second type of chromatic aberration, **transverse chromatic aberration** also arises in real imaging systems. This aberration is related to longitudinal aberration, but it has a different physical basis.  It arises from the blur coupled with the position of the aperture of the optics.
