...
:::{.panel-tabset}
## No transverse chromatic aberration
![Longitudinal chromatic aberration (LCA) and no transverse chromatic aberration (TCA).](images/optics/chromatic-notransverse.png){#fig-optics-notransverse}

## Transverse chromatic aberration
![By shifting the pupil aperture and reducing its size, we block the rays that might have entered the lower part of the lens. These rays would have formed the lower part of the red blur circle.](images/optics/chromatic-transverse.png){#fig-optics-transverse}
:::
