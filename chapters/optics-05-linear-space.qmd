...
There is noticeable chromatic aberration for many types of lenses and materials.  The most surprising optical system with a large amount of chromatic aberration is the human eye!  The point spread at the human retina for different wavelengths is quite different.

![Human point spread functions at 425, 525, and 625 nm in the central fovea.](){#fig-optics-human-psf width=60%}
<!--
Use ISETBio to show the human PSF 

look for s_humanLSF, maybe in ISETBio.

-->

Could do the linespread or the pointspread or both.  Maybe with a plot.  Anyway, doing it with a new ISETBio script would be good.  And the Artal functions?
