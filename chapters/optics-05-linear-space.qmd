...
-->
SMLM techniques are widely used in microscopy. The spatial resolution of SMLM techniques is higher than conventional microscopy imaging, so some people would like to refer to these methods as *nanoscopy*, to emphasize its very fine spatial scale.

The story of SMLM can be traced to W.E. Moerner, who showed that light could be detected from single fluorophores, and then that the fluorophores widely used in biology could be turned on and off (@moerner1989-singlemolecule, @dickson1997-gfp-moerner). Betzig introduced Photoactivated light microscopy (@betzig2006-PALM, PALM), which is a method that takes advantage of Moerner's observation to measure the location individual fluorophores at very high spatial precision. Xiaowei Zhuang independently introduced a similar method, Stochastic optical reconstruction for microscopy (@zhuang2006-STORM).  By repeatedly making these measurements but randomly sampling different molecules in each image, one can produce a visual map of the fluorescent tags at very high resolution.

The Moerner, Betzig, and Hell[^hell-sted] were awarded the [Nobel Prize for their work](https://www.theguardian.com/science/2014/oct/08/nobel-prize-chemistry-trio-microscopy-betzig-moerner-hell#:~:text=Eric%20Betzig%20and%20William%20Moerner,more%20than%2010%20years%20old). Zhuang has won numerous other prizes for her work.
