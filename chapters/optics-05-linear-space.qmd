...
![James Webb Space Telescope's Lyot coronagraph system.](images/optics/optics-lyot.png){#fig-optics-lyot width="80%"}

Modern coronagraphs go beyond simple stops. They use specially shaped apertures and optical elements that adjust the phase of the incoming light, creating a PSF with an extremely dark center. This approach is crucial for **direct imaging of exoplanets**—planets orbiting other stars. The challenge is to block the overwhelming starlight so that the faint reflected light from a nearby planet can be detected.

One ambitious project, the Exo-Life Finder (ELF), uses advanced coronagraphic PSF engineering to search for signs of life on exoplanets (@kuhn2025-astronomy):
...
In these modern designs (@fig-psfengineering-kuhn), the stops are replaced by optical components that precisely control the phase of the light across the pupil. This enables the creation of a PSF with a central region that is suppressed by eight or more orders of magnitude—an essential requirement for exoplanet imaging. Achieving this level of contrast is a major technical challenge, involving not just optics, but also mechanical engineering, materials science, signal processing, and even project management and funding.

This is a striking example of how PSF engineering can be used to push the limits of what we can observe, revealing new worlds that would otherwise remain hidden in the glare of their parent stars.
...
These advances revolutionized biological imaging. Moerner, Betzig, and Stefan Hell[^hell-sted] were awarded the Nobel Prize in Chemistry for their pioneering work. Xiaowei Zhuang has also received many honors for her contributions to the field.

[^hell-sted]: Stefan Hell developed a different approach, called STED microscopy, which uses a special pattern of light to shrink the region where fluorescence occurs, also achieving very high spatial resolution.
:::
