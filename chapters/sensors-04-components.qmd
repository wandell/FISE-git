...
![Electron micrograph cross section illustrating the position of the color filters and microlenses above the photodiode (from @elgamalCMOSImageSensors2005)](images/sensors/16-components/03-microlens-cfa-SEM.png){#fig-components-microlens width="60%"}
