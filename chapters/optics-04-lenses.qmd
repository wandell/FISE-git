...
We will return to the representation of light as waves, wavefronts, and wavefront aberrations in @sec-optics-wavefront.
...
## Reference: Optics terminology
As we move into quantitative lens calculations in the next chapter, keep in mind that optical terminology can sometimes be confusing—especially distinguishing the intrinsic lens **focal length** from the conjugate **image distance** and the physical **sensor plane**. A summary table and discussion are available in the [Optics Glossary: Basic Distances and Planes](resources/optics-glossary.qmd).
:::
