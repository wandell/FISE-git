...
Describing light as rays or waves is important for understanding how light travels through space.  When we measure the light field, say using an image sensor array or light sensitive receptors in the eye, we learn about the intensity of the light field wavefront at a particular location in space.It is remarkable that by measuring the local light field intensities, we can make estimates of distant objects, including their shape and reflectance. This section of the book describes the science and engineering of measuring the light field, which is called Radiometry. This field  
