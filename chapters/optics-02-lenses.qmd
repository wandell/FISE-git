...
::: {.callout-note title="Why lenses bend light" collapse=true}
This is a very nice tutorial from Fermilab about the physical basis of refraction.  The video takes on various (wrong) explanations first, and then explains refraction using principles derived from Maxwell's equations. Very clear and cool stuff.
...
![A lens can be approximated as many small prisms.  The outline shows a spherical surface on the entrance and exit side.](images/optics/07-principles/thinlens-assembled.png){#fig-thinlens-prism fig-align="center" width="80%"}
