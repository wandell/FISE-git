...
![Subpixels](images/displays/display-pixel.png){#fig-display-pixel width="60%"}
...
![Display spectra](images/displays/display-spectra.png){#fig-display-spectra width="70%"}
...
![Display CRT](images/displays/display-crt.svg){#fig-display-crt width="60%"}
...
![LCD display](images/displays/display-lcd.svg){#fig-display-lcd width="70%"}
...
![Display OLED](images/displays/display-oled.png){#fig-display-oled width="70%"}
...
![CIELAB display analysis](images/displays/display-cielab.png){#fig-display-cielab width="70%"}
...
![Display letter](images/displays/display-lettter.png){#fig-display-letter width="70%"}
