...
# Principles and Consequences of the Initial Visual Encoding {#sec-resource-pcc}

{{< include "../includes/WIP-callout.qmd" >}}

[Return to Retinal Encoding](../human-03-retinal-encoding.qmd) \| [Return to book home](../../index.qmd)
...
<img src="PCC_images/lightfield.png" style="width:12cm" />
...
figure.](PCC_images/computations.png){#fig:computations width="12cm"}
...
<img src="PCC_images/Fundamentals.png" style="width:12cm" />
...
brightest bar with a luminance of 300 cd/m^2^.](PCC_images/noise.png){#fig:noise
width="12cm"}
:::
...
[-@Branwyn2016-sc].](PCC_images/pointspread.png){#fig:pointspread width="12cm"}
...
Curcio [-@Curcio1990Photoreceptor].](PCC_images/sampling.png){#fig:sampling
width="12cm"}
...
Cottaris.](PCC_images/excitations.png){#fig:excitations width="12cm"}
...
Sparks.](PCC_images/derivatives.png){#fig:derivativeslater width="12cm"}
...
Example.m).](PCC_images/bayesexample.png){#fig:bayesexample width="12cm"}
...
Cottaris et al. [-@Cottaris2020AComputational].](PCC_images/csf.png){#fig:csf
width="12cm"}
...
to produce this figure.](PCC_images/reconstruction.png){#fig:reconstructions
width="12cm"}
...
[^4]: It is an exercise for the reader to show that real-valued systems that follow the superposition rule also obey the homogeneity rule, not just for integers, but for any real scalar. The converse is not true. A real-valued system can obey the homogeneity rule but not the
superposition rule. For example, $f(x) = \lvert x \rvert$, or $f(x) = x^2$ both satisfy homogeneity, but not superposition.
