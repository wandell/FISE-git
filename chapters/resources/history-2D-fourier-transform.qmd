...
# A brief history of the 2D Fourier transform {#sec-resource-history-2d-fourier}

{{< include "../includes/WIP-callout.qmd" >}}

[Return to Linear Transformations and Optics](../optics-06-linear-transform.qmd) \| [Return to book home](../../index.qmd)
