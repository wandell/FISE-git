...
Paired with a deformable mirror, the Shack-Hartmann sensor underlies **adaptive optics** systems used in astronomy and ophthalmology (@sec-adaptive-optics-astronomy, @sec-adaptive-optics). We describe these systems, and how the sensor enables them, in @sec-optics-wavefront-sensing.
