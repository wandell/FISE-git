...
The reader might consult [Foundations of Vision](https://wandell.github.io/FOV-1995){target=_blank} for more information about human vision; a summary of critical aspects of human vision for image systems engineering is presented in Part IV: Human Vision. The experimental basis of photometry for the weighted sum across wavelengths -the key step to spectral radiometric quantities into photometric quantities- is explained in @sec-human-encoding.
