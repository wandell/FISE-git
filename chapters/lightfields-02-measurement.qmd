...
Assembling an array of lenslets, each with a small sensor region beneath it, extends this angle measurement across the whole light field at once. The resulting instrument, the **Shack-Hartmann wavefront sensor**, is an important instrument in many advanced imaging applications (@eq-lightfield-optical). Paired with a deformable mirror, the wavefront sensor underlies adaptive optics systems used in astronomy and in measuring the optics of the human eye. We describe the measurement instrument and how it enables these applications in @sec-optics-wavefront-sensing, after the idea of a wavefront and its relationship to ray directions has been introduced.
