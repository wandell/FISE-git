...
A slightly different way to think of it is to consider a small lens (called a *lenslet*). We might measuring just a small region of the light field in which the rays are traveling approximately in the same direction.  We say the rays in this small region are *collimated* (parallel to one another).  In that case, the lenslet will focus the rays focuses onto a sensor at a small point. The position of the point will depend on the angle of the rays.

![A lenslet can be used to measure the direction of rays in a small region of the light field. The green lines show what happens when the rays are parallel and along the main axis of the lenslet: the point is centered.  When the rays are traveling at an angle, as suggested by the red lines, the image will be displaced from the center.  The size of the displacement depends on the angle of the rays.](images/lightfields/02-measuring/lenslet.png){#fig-lenslet width="70%"}
