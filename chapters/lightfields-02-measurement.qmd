...
## Measuring light - overview {#sec-lfmeasurement-overview}
Up to now we have been thinking about the full light field.  There are many cases, however, in which we wish to measure how the amount varies over an array of sampled locations.  In that case, we are measuring an image. The image might represent the radiation incident on a surface (such as a photograph) or encoded by a sensor array. The title of this book, foundations of **image** systems engineering, acknowledges that measuring light intensity as an image is central to the field.
