...
Assembling an array of lenslets, each with a small sensor region beneath it, extends this angle measurement across the whole light field at once. The resulting instrument, the **Shack-Hartmann wavefront sensor**, measures the wavefront of an optical light field (@eq-lightfield-optical), and, paired with a deformable mirror, underlies adaptive optics systems used in astronomy and in measuring the optics of the human eye. We describe the instrument and these applications in @sec-optics-wavefront-sensing, once the idea of a wavefront has been introduced.
