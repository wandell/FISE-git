...
![(a) This lens width is smaller than the radius of the circle that matches its surface. The lens might be considered thin. (b) This lens width is approximately equal to the radius of curvature. It is not be a thin lens.](images/optics/08-thinlens/thinlens-definition.png){#fig-thinlens-definition fig-align="center" width="40%"}
...
![Similar triangles for the lens formula.](images/optics/08-thinlens/lensmaker-similartriangles.png){#fig-lensmaker-similartriangles fig-align="center" width="95%"}
