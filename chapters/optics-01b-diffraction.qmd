...
# Diffraction and PSF {#sec-diffraction}

{{< include "includes/WIP-callout.qmd" >}}

## Diffraction and PSF overview {#sec-diffraction-overview}

The ray model in @sec-geometric-optics explains a great deal about pinhole imaging, but it fails at small apertures and sharp edges. In this chapter I describe how Grimaldi, Huygens, and Young established that light must be modeled as a wave, and how Fresnel's mathematics settled the debate with the Poisson spot. I then use the wave model to explain diffraction quantitatively: the Airy pattern sets a physical limit on how sharp a pinhole image can be, no matter how small the aperture. This leads to the **point spread function (PSF)**, the general description of how an optical system images a single point, a concept I use throughout the rest of the book. I close by applying these ideas to pinholes of different shapes and distances, and to the human eye.
...
Even after Young's presentations to the Royal Society, the wave theory met resistance. The loudest was from Henry Brougham who made personal attacks on Young[^optics-01b-diffraction-2]. But serious thinkers also wondered whether a wave theory could be right. What was the medium that supported the waves? Huygens referred to it, but the so-called 'ether' had not been measured[^optics-01b-diffraction-3]. And if the waves were propagating through a medium, wouldn't inhomogeneities cause them to deviate from straight lines?

[^optics-01b-diffraction-2]: Henry Brougham was a particularly fierce critique of Young's entire research program and an ardent defender of Newton's work. His strongest attacks were against Young's important -and accurate!- observations about human color vision. More on that, including Young's response (@young1804-reply) in @sec-human-wavelength-encoding.

[^optics-01b-diffraction-3]: "Now there is no doubt at all that light also comes from the luminous body to our eyes by some movement impressed on the matter which is between the two."—Christiaan Huygens
...
(Maybe we introduce polarization here. Maybe earlier. Maybe put this in a callout instead of the moder double-slit callout.)

What kind of a wave is light?

Transverse or longitudinal wave. Polarization.

[How we know light is a transverse wave.](https://youtu.be/E9qpbt0v5Hw)
...
I will show simulations of a range of human PSFs in @sec-human-retinal-encoding. You can assess your own PSF easily. Glasses or contact lenses are typically designed to sharpen the PSF and counter any astigmatism. To see the PSF of your lens, take off your glasses or contact lenses, and look with one eye at a small spot of light in the dark -maybe a night light from across the room, or one of the LED lights on electronic gear- against in the presence of a uniform background such as a wall. The image you see is the PSF of your own visual system. If you are looking in a dark room, your pupil is probably relatively large. By squinting, you reduce the size of your eye's aperture, and this is likely to sharpen the PSF. The squinting reduces how much the lens contributes to image formation. If the aperture is made quite small, say by using an artifical pupile, the image will be diffraction limited.
