...
Much of the explanation that follows sticks with Newton to treat light as rays. The reader may find this odd, given my explanation in This will help with the explanations, and is approximately correct. We will fix up the calculations, accounting for the fact that the wave description is more accurate, later.  The ISETCam calculations are based on waves.
