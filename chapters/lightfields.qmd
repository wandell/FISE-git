...
In the Chapter @sec-human we will introduce the experimental principles that were used to define how we sum across wavelength and convert radiometric quantities into photometric quantities.
The parallel measures for luminance and illuminance can be found in the Chapter @sec-human, that introduces concepts from human vision that are at the foundation of those measures.
