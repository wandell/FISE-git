...
### Rays and waves
Although the two theories were proposed at about the same time, Newton's ray theory was accepted as correct for roughly a century. Widespread recognition of the value of Huygen's wave theory followed Thomas Young's demonstration, in England to the Royal Society, of the interference pattern created by light passing through two, coherent, nearby sources.

I find great personal value in thinking about the [the history of these ideas.](../resources/optics-diffraction.html) There is great value in using the ray model for many purposes, even though we know it is not correct in other cases.  This very pragmatic approach - use the tool that is accurate enough for the problem at hand - is deeply ingrained in some fields.  Other fields that I have worked in spend a great deal of time proving hypotheses false.  In physics and engineering hypotheses that are half full are still considered valuable, as long as one understands the scope over which the hypotheses can be reasonably applied.
:::

### Which blur dominates?
...
The full derivation of the expected point spread function for the circular and other aperture shapes is described in @goodman2022 (pages 88-94). 

Here is an [ISETCam script that explains the blur calculations](https://htmlpreview.github.io/?https://github.com/wandell/FISET-git/blob/main/code/fise_diffraction.html) in more detail and shows how to calculate blur from diffraction.
