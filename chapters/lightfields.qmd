...
### Calculating the total blur
The image is blurred by two effects: the pinhole size and diffraction. We can do a simple calculations to compare the size of these two blur mechanisms. 
