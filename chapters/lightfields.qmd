...
An important consequence of the wave theory is that as light passes through a pinhole, or near an edge, it will spread out in multiple directions.  The points of the plane wave inside the pinhole send out spherical waves that spread in many directions and this is why the image of the pinhole can be much larger than the pinhole diameter.  In the same way, an image formed through the pinhole will have many rays (plane waves) whose points all contribute spherical waves to the image.  These too spread out and causes the image to blur. This effect, called diffraction by Grimaldi, is insignificant when the pinhole is large compared to wavelength of the light. In that case the plane wave continues relatively unchanged. But when the pinhole diameter is small, and only a small portion of the plane wave compared to the wavelength of light enters the pinhole, the spherical wavefront becomes a relatively large effect and blurs the image (@fig-huygens-waves).
