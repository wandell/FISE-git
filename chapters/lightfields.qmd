...
![Many examples of the failure of the ray model were known by the year 1700. A book containing examples was published by Grimaldi, and a theory of these phenomenon was proposed by Huygens. Even so, the ray model was widely adopted for more than a century.](../images/lightfields/01-ray-wave.png){#fig-ray-wave}
