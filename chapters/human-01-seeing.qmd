...
![R.N. Shepard turning the tables.](images/human/01-seeing/Shepard-turning-tables.png)

### Certain expectations are 

Needs a when-format type representation.

![R.L. Gregory the hollow mask](images/human/01-seeing/Chaplin.wmv.mp4)

### Global context matters

![Ted Adelson Checker Shadow illusion](images/human/01-seeing/Adelson-shadow-checkers.png)

![Lotto version also](images/human/01-seeing/Lotto-illumination.png)
...
![Daikin](images/human/01-seeing/Daikin-local-contrast.png)

Cornsweet Craik O'Brien?
