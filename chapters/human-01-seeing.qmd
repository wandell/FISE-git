...
![Adelson's Checkered Shadow Illusion. Source: [Ted's Website](https://persci.mit.edu/gallery/checkershadow/download/).](images/human/01-seeing/Adelson-shadow-checkers-1.png){#fig-adelson-contrast-shown width="60%"}

#### Checker Shadow Tested
![Adelson's Checkered Shadow Illusion. Notice that the long gray lines pass from A to B.  There is no edge between the lines. Source: [Ted's Website](https://persci.mit.edu/gallery/checkershadow/download/).](images/human/01-seeing/Adelson-shadow-checkers-2.png){#fig-adelson-contrast-tested width="60%"}
...
::: {.content-visible when-format="pdf"}
![Winawer and Horiguchi.  These authors converted the Cornsweet-Craik image into a dynamic, fun demonstration. Each of the segments, as it appears, is darker than the one behind it.  Even though the the new segments appear darker and darker, the segment becomes very dark.  Shout out to [Roger Shepard's Ascening Tone Illusion](https://en.wikipedia.org/wiki/Shepard_tone).](images/human/01-seeing/Winawer-Horiguchi-Contrast.png){#fig-cornsweet width="50%"}
:::
...
The Stanford Chorale kindly sang the illusion  for a class project some 35 years ago. 
...
![Daikin and Bex.  The forehead and the hair are the same intensity.  There are dipoles everywhere.](images/human/01-seeing/Daikin-local-contrast.png){#fig-daikin-bex width="50%"}
