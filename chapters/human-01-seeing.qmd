...
![Adelson's Checkered Shadow Illusion. Source: [Ted's Website](https://persci.mit.edu/gallery/checkershadow/download/).](images/human/01-seeing/Adelson-shadow-checkers-1.png){#fig-adelson-contrast width="60%"}

# Checker Shadow Tested
![Adelson's Checkered Shadow Illusion. Notice that the long gray lines pass from A to B.  There is no edge between the lines. Source: [Ted's Website](https://persci.mit.edu/gallery/checkershadow/download/).](images/human/01-seeing/Adelson-shadow-checkers-2.png){#fig-adelson-contrast width="60%"}
:::
