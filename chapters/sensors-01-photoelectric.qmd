...
The switch from film to digital imaging, with the discovery that semiconductor technology could be used to record irradiance @boyle1970-ccd-first, was extremely important (see [Preface](../index.qmd#sec-preface).  The main impact of these devices, however was largely in the sciences and some high-end applications. These sensor, called charge-coupled devices (CCD), were built using metal-oxide semiconductor technology (MOS). The technology consumed enough power to make them inappropriate for mobile devices.

It was a second critical advance, was Eric Fossum's invention the Complementary Metal-Oxide semiconductors (CMOS) image sensor (@Fossum1993-ccd-dinosaurs @Fossum1995-patent), that brought about the an imaging revolution. Fossum's circuit - the active pixel sensor (APS) - demonstrated that image sensors could be successfully implemented using mainstream CMOS microelectronics processes, and it has been enormously successful (@Fossum2023-invention).  The shift dramatically reduced power consumption, a crucial factor that opened the door to the widespread adoption of image sensors in mobile devices. Moreover, it became possible to integrate the light-sensing pixels with timing and signal processing circuitry onto the same chip (@fig-olympus-overview). This integration enabled new functionalities directly at the sensor level. The new technology enabled the massive global adoption of electronic image sensors. Their widespread use continues to impact many aspects of societies across the globe.
...
![CMOS image sensors (CIS) incorporate integrated circuitry and multiple subsystems.  The circuitry and subsystems, together, enable the capture, transfer and digital encoding of the image. Source: [Evident Scientific](https://evidentscientific.com/en/microscope-resource/knowledge-hub/digital-imaging/cmosimagesensors).](images/sensors/olympusCMOSSensorImage.png){#fig-olympus-overview style=".float-right" width="489"}

Both CCD and CMOS sensors work on the same basic physical principle: they use arrays of tiny, light-sensitive elements called **photodiodes**. A photodiode is a semiconductor device that converts incoming light into an electrical current. When photons strike the photodiode’s active region, they generate electron-hole pairs, resulting in a measurable flow of electrons. Photodiodes are the essential building blocks of modern image sensors, enabling the conversion of optical images into electronic signals—a process known as the **photoelectric effect**. 

Understanding how materials convert light into electrical signals is a fascinating chapter in the history of physics and engineering, shaped by groundbreaking experiments and theories. We begin this section on sensors by describing the discovery of this phenomenon and its fundamental properties.

## The photoelectric effect

The phenomenon that certain materials can convert light to electrons was first reported by Heinrich Hertz [-@Hertz1887-photoelectric2; -@Hertz1887-photoelectric1]. He used a simple apparatus: a loop of wire with a small gap. When exposed to a strong electromagnetic wave at the right frequency, a current was induced in the loop, and if strong enough, a spark would jump across the gap. Hertz discovered that illuminating the wire loop with ultraviolet (UV) light made the spark stronger, allowing it to jump across a larger gap between the wires. He concluded that UV light generated additional current in the wire, demonstrating that light can produce electrical signals.
...
Einstein’s proposal of the photon was initially met with skepticism, as the wave theory of light was deeply established in physics. Even Einstein himself was uneasy with the resulting **wave-particle duality**, believing it pointed to an incomplete understanding of nature. He famously rejected the probabilistic foundations of quantum mechanics, remarking that “God does not play dice.” Niels Bohr, a leading figure in quantum theory, responded, “Einstein, don’t tell God what to do.” The tension between wave and particle descriptions remains a central—and still unresolved—theme in physics.
 <!--
 Einstein didn't simply ignore the wave phenomena. Instead, he envisioned what we might call a "statistical wave-particle" model. He suggested that individual photons somehow retained a wave-like "guiding field" or statistical distribution that determined where they were likely to go. In diffraction, for example, he imagined that while individual photons passed through as particles, their collective behavior was governed by wave-like probability distributions that created the familiar diffraction patterns.

Bohr argued that Einstein was clinging to classical intuitions about reality that quantum mechanics had shown to be inadequate. From Bohr's perspective, the probabilistic nature of quantum mechanics wasn't a sign of incomplete knowledge - it was a fundamental feature of nature at the microscopic scale.
