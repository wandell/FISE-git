...
::: {.callout-note title="Lenard's measurements" collapse="false"}
...
where $h$ is Planck’s constant, $\nu$ is the light frequency, and $\phi$ is the minimum energy required to emit the electron from a material into a vacuum. It is a surface-dependent material property (typically 2–5 eV for metals). In semiconductors used for photodiodes,this  threshold is set by the bandgap $E_g$.
:::
