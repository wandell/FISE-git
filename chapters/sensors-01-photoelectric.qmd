...
A major breakthrough came in the early 1990s with the development of the modern Complementary Metal-Oxide Semiconductor (CMOS) active pixel sensor (APS) by Eric Fossum and his team at NASA's Jet Propulsion Laboratory (@fossum1993-ccd-dinosaurs; @fossum1995-patent). Earlier CMOS sensors had relied on passive pixels (PPS), which suffered from high noise and slow readout. By placing an active amplifier in each pixel and incorporating on-chip timing, control, and analog-to-digital conversion, the JPL team demonstrated the "camera-on-a-chip." Because CMOS sensors could be manufactured using standard microelectronics fabrication lines, they consumed far less power than CCDs and paved the way for the widespread adoption of electronic image sensors in mobile devices and many other applications.
