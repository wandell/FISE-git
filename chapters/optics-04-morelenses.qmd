...
Multi-lens systems are often summarized by their ray transfer matrix. This is a very efficient way to communicate about some of the system properties. Two particularly valuable system properties, the back focal length $f_B$ and effective focal length $f_{E}$, can be calculated from the entries of the ray transfer matrix, $M$
...
<!--
https://latex.codecogs.com/svg.image?\begin{pmatrix} A & B \\ C & D \end{pmatrix}
-->
