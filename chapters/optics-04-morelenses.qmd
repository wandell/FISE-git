...
N.B. I use a simple parameterization of the ray state, $(y,\theta)$. There are others -and they can be very smart- who prefer to use the **reduced-angle convention**.  They incorporate the index of refraction into the angle $(y,n\,\theta)$.  In that framing, replace $C$ by $C/n_{\text{out}}$. 
