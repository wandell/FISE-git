...
:::{.panel-tabset}
# Tessar 
![[Cooke became Tessar lens](https://en.wikipedia.org/wiki/Tessar). An evolution of the Cooke Triplet, adding a fourth element to improve performance and correct aberrations](images/optics/09-morelens/tessar-wikipedia.png){#fig-optics-tessar width="70%"}

# Petzval 
![[Petzval lens](https://en.wikipedia.org/wiki/Petzval_lens) for portraits, known for its large aperture but limited field of view. It's still used in some specialized applications. Big fight.  Biotar is another portrait lens.](images/optics/09-morelens/petzval-wikipedia.png){#fig-optics-petzval width="70%"}

# Fisheye 
![The fish eye lens.](images/optics/09-morelens/fisheye-wikipedia.png){#fig-optics-fisheye width="70%"}
:::
