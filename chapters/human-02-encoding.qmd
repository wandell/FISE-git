...
Get the Stan Schein image here.  Also a panel-tabset

![S-cone sampling image from Wikler and Rakic, 1990. Maybe we add the one from Stan Schein in a tabset.](images/human/02-encoding/s-cone-sampling.png){#fig-scone-sampling width="60%"}
