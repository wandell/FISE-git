...
How does the spatial sampling of the cones compare to the optical PSF? One comparison we can make is for the central fovea. There the inner-segment apertures are about 1.5–2 μm in diameter. Using ISETCam, we can calculate the diffraction-limited Airy disk diameter (to the first minimum) for 550 nm light. For a 3 mm pupil, the f-number of the human optics is 17 mm / 3 mm ≈ 5.6. Using @eq-airydisk1, this is:
