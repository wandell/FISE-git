...
The regularity of the cone sampling mosaic in the central retina was a surprise. Miller was the first to crisply show it, I think.  Others had been thinking the density was high but the sampling grid was irregular.  In fact, the packing is fairly tight, sometimes called a triangular grid, and sometimes called a hexagonal packing scheme.  I need to explain the ideas.  Note the size of the inner segment apertures.  Maybe 1.5 microns.
