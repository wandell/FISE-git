...
### Retinal layers
![Layers from Fisher. Source: [New Scientist](https://www.newscientist.com/gallery/dn14971-small-world-gallery/)](images/human/02-encoding/retina-ej.png){#fig-retina-ej width="70%"}
...
![Miller cone inner segment spatial sampling](images/human/02-encoding/inner-segments-foveal.png){#fig-inner-segment-miller width="60%"}

::: panel-tabset
### Cone classes
![S-cone sampling image from Wikler and Rakic, 1990](images/human/02-encoding/s-cone-sampling.png){#fig-scones-wikley width="60%"}

### S-cones (Schein)
![Schein scone procion yellow staining.](images/human/02-encoding/scones-schein.png){#fig-scones-schein width="60%"}
...
Measure the optical spread with respect to the cone mosaic image.  
