...
## Image distance {#sec-optics-focaldistance}
...
The notion of a **circle of confusion** is useful for understanding and quantifying why the depth of field depends on the aperture.  Consider image formation with a thin lens at a fixed distance from the image plane (@fig-optics-coc1).  The middle image shows a point that is at the image distance.
