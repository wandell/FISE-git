...
<!-- s_opticsCoC.m -->
![Narrowing the aperture reduces the size of the circle of confusion.](images/optics/optics-coc-2.png){#fig-optics-coc2 width="60%"}

This is a link: `r ieLink({'scripts','optics','s_opticsCoC.m'})`

This is a link: `ieLink({'scripts','optics','s_opticsCoC.m'})`
