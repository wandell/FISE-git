...
Say something about the formula.
...
![Pseudo-color image showing depth of field in meters (pseudocolor) for relative to different distances (vertical axis) and $f/\#$ (horizontal axis).  The calculation is done for a 100 mm focal length lens.](images/optics/optics-dof-image.png){#fig-optics-dof width="60%"}
