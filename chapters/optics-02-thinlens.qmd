...
![Narrowing the aperture reduces the size of the circle of confusion.](images/optics/optics-coc-1.png){#fig-optics-coc2 width="60%"}

### Formula for depth of field

Describe the formula in words.  Maybe show the graph from class slides calculation.
