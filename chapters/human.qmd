...
## The eye
The eye includes optics for image formation (optics) and neural tissue for sensing (light absorption). The physiological optics has a fixed (cornea) and flexible (lens) component. Together, their optical properties determine the optical light field. The optics are dynamic in at least two ways: the size of the entrance pupil and the optical power of the lens both vary. The pupil opens and closes depending on ambient light conditions and as well as some non-visual events in the brain.  The flexible lens changes its power, which enables (young) people to bring either close or far objects into focus on the retina. This flexibility is lost with age (presbyopia, CITATION NEEDED). The direction of gaze also varies as people move their head and eyes, depending on the viewer's intention.  
