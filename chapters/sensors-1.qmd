...
## Quantifying the photoelectric effect
 The conversion of photons to electrons is inherently random: even a perfectly stable light source produces a variable number of electrons. The number of absorptions obeys the Poisson distribution. This insight was formalized in the 20th century in two groups of scientists: People working on visual sensitivity (@Pirenne1951-poisson, @Barlow1956-retinalnoise) and people working on light and image sensors (@Mandel1959-poissonabsorptions). This fundamental statistical fluctuation is a key aspect of how light interacts with matter and a fundamental part of the field of quantum optics.
