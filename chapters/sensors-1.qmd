...
Fossum's breakthrough was enormously significant. By leveraging standard CMOS technology, it became possible to integrate not only the light-sensing pixels but also the timing, control, and signal processing circuitry onto the same sensor chip. This integration enabled new functionalities directly at the sensor level (@fig-olympus-overview). Furthermore, this shift dramatically reduced power consumption, a crucial factor that opened the door to the widespread adoption of image sensors in mobile devices. Equally important, CMOS fabrication facilities are fundamental to the production of countless types of integrated circuits, and the technology has advanced to remarkably small scales. This accessibility and miniaturization have fueled the massive global adoption of electronic image sensors.
