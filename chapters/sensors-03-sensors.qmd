...
At the center of the sensor array, the incidence of the chief ray from the center of the lens is close to perpendicular to the photodiode array. There, a lens centered above the photodiode works well to simply concentrate the rays. At the edges of the array, however, the angle of the chief ray is relatively steep, say 35 degrees. To redirect the rays toward the photodiode, the microlens and the color filter are shifted laterally.  This redirects the angle of the rays so that more of them  arrive at the photodiode.
...
The microlens was important for classic, frontside illuminated sensors when the path from the lens through the metal layers was quite long and the angle of the chief ray at the edge was fairly large. Even so, the arrays were not enough to prevent significant cross-talk. For large pixels, and the initial sensor pixels were 6 or more microns, this technology along was quite effective.

As pixel sizes became smaller, on the order of 1.5 or 1 micron, the impact of diffraction became increasingly important. After passing through these small pixel apertures, the wavefronts would spread and significant amounts of energy would be deposited in adjacent pixels. **Deep trench isolation (DTI)** was a technology developed to reduce the spread of the light between pixels. Designers developed methods of placing trenches inside the pixel and then filling these trenches with with an insulating material (like silicon dioxide or nitride).  This formed very thin walls within the pixel that would stop the photons that had passed through, say, a green color filter into the photodiode that should only be illuminated by photons that had passed through a red color filter.  Deep trench isolation, therefore, reduced this scattering and thus improved the resolution and color accuracy.   
