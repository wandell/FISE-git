...
The **Gaussian** and **Lorentzian** (sometimes called Cauchy) PSFs are more like practical shortcuts. They’re simple formulas that do a pretty good job of describing how real lenses blur light. The Gaussian is especially popular because it’s easy to work with in calculations. The Lorentzian has fatter tails, which means it’s better for modeling systems where light gets scattered a lot—like if your lens is scratched or there’s a lot of internal reflection.

![Cross-section through three point spread functions that are commonly used to characterize imaging optics.  Use ISETCam to redraw.  This was made using FISE-Optics.](images/optics/02-optics-PSF_comparison.png){#fig-psf-comparison width="70%"}
...
This tells you how “tight” the spot can be focused.
...
The Gaussian is the classic “bell curve.” It’s simple and often a good enough approximation for many optical systems.
