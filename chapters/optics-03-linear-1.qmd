...
The cross-section graphs of these PSFs are a useful way to see the details of their differences. We can go beyond the curves to visualize how these different PSF shapes are manifest in spectral radiance images. I compare these three PSFs and a fourth one, called the **pillbox**, in a <a href="../code/fise_opticsPSF.html" target="_blank"> an ISETCam live script, fise_opticsPSF.</a>  The images in @fig-psf-image were made using that script.
