...
Viewed from this perspective, consumer photography - a very large and important image system application - is the odd-one out. Consumer photographs are created to store memories and evoke emotions, not to guide navigation or immediate decisions. This massive field, really the first of the image system applications, serves these important human functions. As I discuss in later chapters, the technologies for evaluating consumer photography differ from standard engineering metrics because of their heavy reliance on the properties of human perception.
