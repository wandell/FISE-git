...
These experimental results were established, but there was no unified theory. James Clerk Maxwell brought these findings together in a set of differential equations—now known as **Maxwell’s equations**. Maxwell showed that oscillating electric and magnetic fields can propagate through space as waves. He found that the predicted speed of these waves matched the measured speed of light! This led Maxwell to conclude that light, too, is an electromagnetic wave. His work unified electricity, magnetism, and optics into a single theoretical framework: electromagnetic radiation across a range of wavelengths.

## The environmental light field {#sec-lightfields-types}
Electromagnetic radiation fills the environment, traveling in many directions and often interacting with materials. We call the radiation field in the visible wavelength band the *environmental light field*. 
