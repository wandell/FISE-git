...
# Part VII:  Appendix {#part-appendix}
{{< include "includes/WIP-callout.qmd" >}}

## Appendix Overview {#part-appendix-overview}
...
### General Linear Systems (`appendix-01-linearsystems.qmd`)
...
### Shift-Invariant Systems (`appendix-02-spaceinvariance.qmd`)
...
*This appendix is planned. It will provide practical software examples, likely using ISETCam and MATLAB/Python, to illustrate the key concepts from the main chapters. It will serve as a hands-on resource for simulating optical systems, sensor behavior, and image processing algorithms.*