...
![When a ray crosses the boundary between two materials, it may continue but change direction. This occurs because the speed of electromagnetic radiation differs in different materials. The material parameter that describes the speed is the *index of refraction* ($n$ and $n'$).](../images/optics/snell-refraction.png){#fig-snell-law fig-align="center" fig-cap-location="bottom" width="50%"}
...
The variables $n$ and $n'$ are the *index of refraction* of the materials. The value is related to the speed of the electromagnetic radiation in the material. In a vacuum, $n$ is $1.0$, and it is very close to $1.0$ in air.  In some materials, such as glass, the radiation travels more slowly and the index might be $1.3$ or even $1.5$. In many common materials the radiation slows down because the light induces an opposing electromagnetic signal (predicted by Maxwell's equations).  There are some materials, such as liquid crystals, whose material interactions produce interesting and useful effects that we will describe in @sec-displays.
