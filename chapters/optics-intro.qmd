...
Typically we do not represent the amplitude of the wavefront across space.  And many devices only modulate the phase (spatial light modulators can have this property.)  But laser beams are a crisp example of a wavefront that has a narrow Gaussian intensity profile.
...
In about the year 150, the Greek scientist Ptolomy described developed a scientific understanding of light and optics.  He observed, and quantified, that the direction of a ray of light passing from one medium to the next (air to water, air to glass) was changed.  This change in direction is what we now call **refraction**. We do not name the quantitative laws of refraction for him because he got the values wrong. These were subsequently computed by Ibn Sahl in Persia, around 934, who used his measurements to design lenses. The Dutch astronomer Willebrord Snellius also got the principle and the numbers right in work that was published after his death. In the modern age and the West, we refer to formula for refraction as Snell's Law. The law is illustrated in [#fig-snells-law].
