...
::: margin
![When a ray travels between two different materials, it changes direction at the boundary. This occurs because light travels at different speeds in different materials. We describe this material property as the index of refraction ($n$ and $n'$). Snell's Law relates the angle of the incoming ray (measured from a line perpendicular to the surface) to the angle of the outgoing ray.](../images/optics/snell-law2.png){#fig-snell-law fig-align="center" width="50%"}
:::
