...
### Lens positioning: SLR and DSLR {#sec-lens-positioning-slr}
...
SLR cameras were the coolest ones when I was middle-aged.  The SLR design replaced the **rangefinder** approach.
A rangefinder camera has two separate optical paths:
...
### Lens positioning: mobile devices {#sec-lens-positioning-mobile}
