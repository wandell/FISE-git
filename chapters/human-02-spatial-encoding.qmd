...
::: {.panel-tabset}
### Cone types
![L,M cone types, intermixed with rods, and some S-cone hints.  Lots of rods.  Near periphery. Source: @wikler1990-photoreceptor-subtypes](images/human/02-spatial-encoding/s-cone-sampling.png){#fig-scones-wikley width="60%"}

### S-cones sampling
![S-cone procion yellow staining from de Monasterio and Schein.  Source @demonasterio1981-scones see also @demonasterio1985-scones  ](images/human/02-spatial-encoding/scones-schein.png){#fig-scones-schein width="60%"}
:::
...
::: {.panel-tabset}
### Fovea
![A 1x1 deg patch centered on the fovea. Notice that there are no S-cones in the very center and no rods throughout.](images/human/02-spatial-encoding/coneMosaic-0-deg.svg){#fig-mosaic-0 width="70%"}

### 3 deg
![A 1x1 deg patch at 3 deg eccentricity.  The inner segment apertures have increased in size. S-cones are present, but few rods.](images/human/02-spatial-encoding/coneMosaic-3-deg.svg){#fig-mosaic-3 width="70%"}

### 6 deg
![A 1x1 deg patch at 6 deg eccentricity. Even larger apertures. More rods.](images/human/02-spatial-encoding/coneMosaic-6-deg.svg){#fig-mosaic-6 width="70%"}
...
### 12 deg
![A 1x1 deg patch at 12 deg eccentricity. Aperture size is increased to XX microns. Lots of space for the rods between the cones. ](images/human/02-spatial-encoding/coneMosaic-12-deg.svg){#fig-mosaic-12 width="70%"}
:::
...
:::{.panel-tabset}
### PSF for 550nm
![PSF at 3 deg:  550nm](images/human/02-spatial-encoding/conePSF-550.svg){#fig-psf-550nm width="60%"}

### PSF for 480nm
![PSF at 3 deg:  480nm](images/human/02-spatial-encoding/conePSF-480.svg){#fig-psf-480nm width="60%"}
:::
