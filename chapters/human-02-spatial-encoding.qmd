...
The importance of the transform domain in optics and engineering led vision scientists to ask whether measurements using harmonics could be useful for understanding the human visual system. One of the first people to see the connection was the engineer Otto Schade, who developed the concept of the modulation transfer function (@sec-MTF) for other image systems engineering questions.
