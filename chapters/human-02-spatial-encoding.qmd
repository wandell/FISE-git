...
I downloaded the [Mantiuk github repository](https://github.com/gfxdisp/stelaCSF.git).
 
 It is now on my home computer.  It includes code for reading the datasets.  Maybe we include the data files in the book? 
