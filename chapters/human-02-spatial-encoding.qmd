...
## The optical image {#sec-adaptive-optics}
In the late 1990s, it became possible to measure how the physiological optics blurs the light in the living human eye.  The key technology for making this measurement is called **adaptive optics**, and it is based on a measurement device called the **Shack-Hartmann wavefront sensor**. This technology, originally developed by astronomers pointing their telescopes at the stars, measures the blurring (wavefront distortion) by the optical system. 

The idea of the measurement is illustrated in @fig-wavefront-aberrometer.  A narrow beam of light is sent into the center of the pupil. is reflected from the inner segement layer at the back of the eye.  There it forms a fairly small spot that reverses path, back out the through the optics.  If the eye's optics were absolutely perfect, the rays from this small reflected spot would be parallel (collimated). The optics would be diffraction limited.  But the rays do not come out perfectly collimated.  They are distorted and we call this the wavefront aberration of the eye.  

![Aberrometer](images/human/02-encoding/wavefront-aberrometer.png){#fig-wavefront-aberrometer width="60%"}
