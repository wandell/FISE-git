...
Diffraction is explained by the wave-like behavior of light. We can also see diffraction in other waves, such as sound or water waves.

These are notes, many of them from ChatGPT or Perplexity. They need to be organized.

I am interested in how to link out to files like this that are slightly off the main book path.
...
When a wave encounters an obstacle or aperture, its path and form change: the wave spreads out. This is different from the way a ray behaves. A ray that encounters an obstable is either absorbed or reflected and a shadow is cast behind the obstacle. But a wave spreads into regions that ray optics would predict to be in shadow.
