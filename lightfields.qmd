...
It is possible, of course, to convert this parameterization back to an angular representation with some simple algebra. But it will be useful, in the next chapter, to use the two spatial coordinates for the optical light field parameterization.
